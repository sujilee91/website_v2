          ...
          <MuiThemeProvider theme={customTheme}>
            <Grid container spacing={8} className={this.props.classes.cards}>
              <Grid
                ...
                sm={6}
                xs={12}
                className={this.props.classes.aboutCard}
              >
                <img src={Nomad} alt="RemoteWorker" />
                <Typography variant={'overline'}>Remote Worker</Typography>
                <Typography variant={'body1'}>
                  Remotely working frontend ux/ui developer who barely getting
                  out of her house. My cat, Simba, hang out with me and help me
                  beat the loneliness.
                </Typography>
              </Grid>
              <Grid
              ...
              >
                ...
                <Typography variant={'body1'}>
                  Beautiful scenary of Rockie mountain is in my backyard. Me &
                  my husband camerized 1968 Dodge van so when its warm, it's
                  adventure time!
                </Typography>
              </Grid>
              <Grid
            ...
            >
              <Grid item lg={12} xs={12}>
                <Button
                  ...
                  variant="contained"
                  size={'small'}
                  className={this.props.classes.resumeButton}
                  onClick={() => {
